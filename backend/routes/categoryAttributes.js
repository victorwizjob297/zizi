...
router.get('/category/:categoryId', async (req, res) => {
  try {
    const attributes = await CategoryAttribute.getByCategory(req.params.categoryId);
...
router.get('/category/:categoryId/searchable', async (req, res) => {
  try {
    const attributes = await CategoryAttribute.getSearchableByCategory(req.params.categoryId);
