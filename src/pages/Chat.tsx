...
const Chat = () => {
  ...
  const { data: conversationsResponse, isLoading: conversationsLoading, refetch: refetchConversations } = useGetConversationsQuery();
  ...
  }, [token, selectedConversation?.id, user?.id, refetchMessages, refetchConversations]);
              ...
              {messagesLoading ? (
                ...
                <>
                  {messages.map((message) => {
                    ...
                    const isRead = readMessages.has(message.id) || message.read_at;
